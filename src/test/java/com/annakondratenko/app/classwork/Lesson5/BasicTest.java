...
// but we will use earthier solution
    ...
    } //read the file and write data to array expectedResults
...
//because tests in alphabetical order we use 'a', 'b' to order tests
    ...
    public static int[] fromStringArray(String[] array){
        ...
        int[] result = new int[array.length]; //create new array with name result with length of String array

        for (int i=0; i<array.length; i++){

            result[i] = Integer.valueOf(array[i]); //convert from string to integer
